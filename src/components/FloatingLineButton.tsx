...
export function FloatingLineButton() {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full px-5 py-3 text-white font-semibold shadow-lg hover:opacity-90 transition-opacity"
